...
<div class="group relative transition-all duration-300">
    ...
    <a href="{{ config('app.url') }}/{{ $project->slug }}" target="_blank"
        class="absolute right-3 top-3 z-40 flex h-7 w-7 items-center justify-center rounded-lg bg-white opacity-0 transition-all duration-300 hover:bg-white group-hover:opacity-100 dark:bg-secondary-700 dark:hover:bg-secondary-700 hover:ring-2 hover:ring-secondary-500 dark:hover:ring-secondary-500">
    ...
    <a href="{{ route('filament.admin.resources.projects.edit', ['record' => $project]) }}" class="block relative">
        <div class="relative">
            {{-- Category Badge --}}
