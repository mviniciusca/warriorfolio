...
<div>
    <div id="wrapper-{{ $id }}">
        ...
        <div id="{{ $id }}" tabindex="-1"
            ...
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-2 px-5 py-1 text-xs">
        ...
        @if($style == 'bumper')
        <div id="{{ $id }}" tabindex="-1"
            class="animate__animated animate__fadeInDown animate__delay-1s fixed top-0 z-50 mx-auto w-full rounded-lg bg-secondary-100 bg-contain bg-center bg-no-repeat dark:border-b dark:border-b-secondary-800 dark:bg-secondary-950">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-2 px-5 py-1 text-xs font-light">
                <div class="alert-content">
                    {!! $message !!}
                </div>
                <div class="my-4">
