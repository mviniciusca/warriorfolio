<div class="relative">
    <form wire:submit="submit" class="relative">
        <div class="absolute inset-y-0 left-0 flex items-center pl-2.5 pointer-events-none" wire:ignore>
