...
@if ($hero->hero['section_subtitle'] ?? false)
    <h2
        class="animate__animated animate__fadeInUp animate__delay-1s mb-6 hero-subtitle leading-tight tracking-tight shadow-current {{ ($hero->hero['bg_image'] ?? null) && ($hero->hero['is_highlight'] ?? null) ? 'bg-white  dark:bg-black px-2 max-w-auto' : '' }}">
