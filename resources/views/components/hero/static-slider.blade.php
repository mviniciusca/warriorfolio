...
@if (data_get($hero, 'hero.slider_is_active'))
    <div
        class="mx-auto py-8 animate__animated animate__fadeInUp animate__delay-1s flex w-full flex-wrap justify-center gap-4 md:justify-around lg:mt-8 {{ ($hero->hero['is_filled'] ?? false) ? 'lg:mb-24 md:mb-12 mb-6' : 'mb-1' }}">
