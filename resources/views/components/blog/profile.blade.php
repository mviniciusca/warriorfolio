...
<div>
    <section class="my-12 flex items-start border-b border-b-secondary-200 not-italic dark:border-b-secondary-800">
        <div class="mr-3 inline-flex items-start py-4 text-sm">
            ...
            @endif
            <div>
                <p href="#" rel="author" class="text-base">{{ $user->name }}</p>
                <p class="pb-2 text-xs">{{ $user->profile->job_position }} - {{ $user->profile->localization }}</p>
