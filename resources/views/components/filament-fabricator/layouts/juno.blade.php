                                        ...
                                        <div class="flex flex-1 flex-col justify-between p-4">
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between">
                                                    <span
                                                        class="text-xs text-secondary-500 dark:text-secondary-400">April
                                                        24, 2025</span>
                                                    <span
                        ...
                        <div class="tab-pane hidden" id="contact-content">
                            ...
                            <div class="grid gap-8 md:grid-cols-2">
                                ...
                                <div class="space-y-6">
                                    <div class="p-6">
                                        <h3
                                            class="mb-4 text-sm font-medium text-secondary-900 dark:text-secondary-100">
