...
<div class="py-2 max-w-7xl mx-auto {{ $is_center ? 'text-center' : 'text-left' }}">
    ...
    <a target="{{ $bumper_target }}" href="{{ $bumper_link ?? '#' }}">
        ...
        <div class="mb-2 inline-flex items-center justify-between rounded-full bg-secondary-100 px-1 py-1 pr-4 text-sm text-secondary-700 hover:bg-secondary-200 dark:bg-secondary-800 dark:text-white dark:hover:bg-secondary-700"
            role="{{ $bumper_role }}">
