@aware(['page'])
{{-- Hero Background --}}
<div class="-mt-36 bg-hero animate__animated animate__fadeIn animate__delay-2s
        ...
        <section>
            <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                ...
                <div id="app-image-showcase">
                    <img class="rounded-t-xl mt-8 shadow-md animate__animated animate__fadeInUp animate__delay-5s"
