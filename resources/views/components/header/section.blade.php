        ...
        <div class="app-logo flex flex-wrap items-center gap-4">
            ...
            <div>
                <button data-collapse-toggle="mobile-menu-2" type="button"
                    class="ml-2 inline-flex items-center rounded-lg p-2 text-sm hover:bg-secondary-100 focus:outline-none focus:ring-2 focus:ring-secondary-200 dark:hover:bg-secondary-950 dark:focus:ring-secondary-800 lg:hidden"
