...
<div
    ...
    <x-themes.common.partials.hero.button-group :color="$button['color'] ?? null" :icon="$button['icon']"
        :style="$button['button_style']" :target="$button['button_target']" :title="$button['button_title']"
