...
<div>
    <div
    class="flex font-bold text-zinc-500 text-sm gap-8 mb-1 p-4 rounded-lg content-between justify-start
    hover:opacity-95 transition-all duration-100
    @if($mail->is_read) bg-zinc-100 font-normal opacity-60 @else bg-zinc-50 @endif
    @if($mail->is_starred)  @endif"
    >
        ...
        <div class="w-2/5 overflow-x-hidden" id="name-email">
            <p>{{ $name }}</p>
