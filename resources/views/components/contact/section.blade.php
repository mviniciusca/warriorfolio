...
<x-core.layout class="{{ $info->contact_section_fill ? 'bg-secondary-100 dark:bg-secondary-950' : '' }}" id="contact">
    ...
    <div class="mx-auto mt-4 max-w-2xl text-center text-lg">{!! $info->contact_section_subtitle_text !!}</div>
    @endif
    <div class="mt-24 flex lg:gap-8" id="contact-address">
        ...
        <div
            ...
            <div class="relative flex flex-wrap rounded bg-secondary-100 py-6 text-xs shadow-md dark:bg-secondary-900">
