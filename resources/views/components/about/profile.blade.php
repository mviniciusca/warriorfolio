...
<div
    ...
    <section class="mx-auto" id="profile-section-two">
            ...
            @if ($profile->job_position || $profile->localization)
                <div class="tracking-tight">
                    @if ($profile->company ?? null)
                        <span class="flex items-center justify-start gap-2 py-1 text-sm font-semibold opacity-90">
            ...
            @if ($profile->is_downloadable && $profile->document)
                <div class="mx-auto py-2 text-center">
                    <a href="{{ asset('storage/' . $profile->document) }}" target="new">
                        <x-ui.button :$is_section_filled_inverted :icon="'download-outline'" :style="'filled'"
        ...
        <div class="my-4 flex flex-wrap content-center items-center justify-center text-sm tracking-tight"
            id="skills">
            @if ($profile->skills)
