...
<div
    ...
    <section id="profile-section-one" class="mx-auto">
        <div class="mb-8" id="profile-avatar">
            @if ($profile->avatar)
            <x-curator-glider
                class="relative mx-auto my-2  lg:w-36 md:w-28 w-28 p-2 rounded-full border border-white/5 object-cover  dark:bg-secondary-800 bg-secondary-100 lg:my-8"
                :media="$profile->avatar" />
            @else
            <img class="relative mx-auto my-2  lg:w-36 md:w-28 w-28  p-2 rounded-full border border-white/5 object-cover  dark:bg-secondary-800 bg-secondary-100 lg:my-8"
    ...
    <section id="profile-section-two" class="mx-auto">
        <div class="flex flex-wrap items-center justify-center gap-4 md:justify-between lg:inline-block">
            ...
            <div class="md:mb-4 tracking-tight">
                ...
                <span class="mt-2 flex gap-1 items-center text-sm opacity-80">
