    ...
    <section class="mt-24">
        <div class="container max-w-7xl px-5 mx-auto">
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                ...
                <div class="p-8 md:w-1/4 sm:mb-0 mb-0 filter opacity-90 transition-all duration-100">
                    <div class="overflow-hidden p-2 rounded-xl">
                        <img alt="{{ $project->name }} - picture" class="object-cover rounded-xl object-center w-full"
