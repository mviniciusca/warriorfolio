<div class="container mx-auto">
    <div
        class="mx-auto border border-opacity-50 bg-opacity-40 border-secondary-400 grid lg:flex gap-8 py-8 px-8 bg-secondary-50 dark:bg-secondary-950 items-center justify-center lg:justify-between rounded-xl">
        <img class="h-48"
