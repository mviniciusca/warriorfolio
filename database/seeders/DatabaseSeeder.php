       ...
       DB::table('users')->insert([
        ...
        Tag::factory()->count(1)->createMany([
           ...
           [
            'title' => 'Vercel',
            'slug'  => 'vercel',
            'color' => '#000000', // TailwindCSS color equal to black
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentcolor" viewBox="0 0 512 512"><path fill-rule="evenodd" d="M256 48l240 416H16z"/></svg>'
           ]
